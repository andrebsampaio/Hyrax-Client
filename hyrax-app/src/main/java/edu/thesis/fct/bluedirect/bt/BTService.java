...
public class BTService {
    ...
    private static final String NAME_SECURE = "Hyrax";
    private static final String NAME_INSECURE = "Hyrax";
    ...
    private class ConnectedThread extends Thread {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mmOutStream.writeUTF(MeshNetworkManager.getSelf().getIp());
    ...
    private void listenPackets(DataInputStream input) throws IOException {
