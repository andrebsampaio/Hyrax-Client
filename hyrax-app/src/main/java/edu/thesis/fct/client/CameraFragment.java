...
public class CameraFragment extends Fragment
    ...
    private static final int REQUEST_CAMERA_RESULT = 5;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View flagsView = inflater.inflate(R.layout.fragment_camera2_basic, container, false);
   ...
   /* private void openCamera(int width, int height) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M || Build.MODEL.contains("M")){
                ...
                if(ContextCompat.checkSelfPermission(activity, android.Manifest.permission.CAMERA)
                    ...
                    if (shouldShowRequestPermissionRationale(android.Manifest.permission.CAMERA)){
                        Toast.makeText(activity,"No Permission to use the Camera services", Toast.LENGTH_SHORT).show();
                    }
