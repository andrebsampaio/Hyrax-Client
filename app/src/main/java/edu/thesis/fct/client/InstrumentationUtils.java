...
public class InstrumentationUtils {
    ...
    static final int WD = 3;
    static final int IMG_LIST_RQ = 4;
    static final int ADD_INDEX_RQ = 5;
    static final int P2P_TRANSFER = 6;
    static final int BYTES_C2C = 7;
    static final int BYTES_C2S = 8;
    static final int PACKETS_C2C = 9;
    static final int PACKETS_C2S = 10;
    static final int RX = 11;
    static final int TX = 12;
